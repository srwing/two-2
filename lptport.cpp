...
*/
//drivesim - last     
//	DlPortWritePortUchar(0x768, (UCHAR)synch);
//	      DlPortWritePortUchar(0x378, (UCHAR)synch);
//	      DlPortWritePortUchar(0x378, (UCHAR)0);
//*****************
	for (int i =0; i<50;i++) {
		Out32(LPT_data,synch);
	}
	Out32(LPT_data,0);
